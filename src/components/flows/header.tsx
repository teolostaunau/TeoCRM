    ...
    <div className="flex flex-col gap-1.5 px-6 pt-5">
      <div className="flex flex-wrap items-center gap-3">
        ...
        <button
          ...
          title={t("flows.header.backToFlows")}
          aria-label={t("flows.header.backToFlows")}
        ...
        <input
          ...
          spellCheck={false}
          aria-label={t("flows.header.namePlaceholder")}
        ...
        {dirty && (
          <span
            ...
            title={t("flows.header.unsavedChanges")}
            aria-live="polite"
          >
            <span className="h-1.5 w-1.5 rounded-full bg-amber-400" />
            {t("flows.header.edited")}
          </span>
        )}
      ...
      <input
        ...
        aria-label={t("flows.header.descriptionPlaceholder")}
