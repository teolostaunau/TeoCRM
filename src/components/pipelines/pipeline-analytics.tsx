        ...
        <Tooltip>
          <TooltipTrigger
            render={
              <button
                type="button"
                aria-label={t("pipelines.analytics.tooltips.aria", { label })}
