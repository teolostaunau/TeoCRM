...
function relativeTime(
  ...
  if (diffSec < 60) {
    return t("dashboard.activity.relative.seconds", {
      count: Math.max(1, diffSec),
    })
  }

  if (diffSec < 3600) {
    return t("dashboard.activity.relative.minutes", {
      count: Math.floor(diffSec / 60),
    })
  }

  if (diffSec < 86400) {
    return t("dashboard.activity.relative.hours", {
      count: Math.floor(diffSec / 3600),
    })
  }

  if (diffSec < 2_592_000) {
    return t("dashboard.activity.relative.days", {
